...
const Add_Branch = () => {
  ...
  const handleSubmit = (event) =>{
    ...
    if(name,address,listing_id,country,state,city,address,google_map_latitude,google_map_longitude)
    {         
      BranchRegistration(name,address,listing_id,country,state,city,address,google_map_latitude,google_map_longitude);
    } 
  else {
    Swal.fire({
   ...
   async function BranchRegistration(name,listing_id,country,state,city,address,google_map_latitude,google_map_longitude){
    ...
    await axios.post("https://callistoworld.io/lara/public/api/BranchRegistration",
    f_data ,
 { headers: {
