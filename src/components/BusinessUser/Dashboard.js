...
const Profile = () => {
  ...
  const [ListingWallet, setListingWallet] = useState(null);
  ...
  const view_data = async () => {
    ...
    .then(res => { 
      ...
      setListingWallet(res.data.ListingWallet);
  ...
  const downloadQRCode = () => {
    ...
    return (
      ...
      {BusinessListing != null && ListingWallet != null
   ?
     <>      
       <div className="row">
 ...
 <div className="container">
   <div className="row">
     <div className="col-xl-8 col-lg-8 col-md-8 col-sm-12 col-12">
       ...
       {BusinessListing.is_active != "active" &&
         <div class="alert alert-danger" role="alert">
            Your Business is not Verified by Our Team. Please complete your Registration Form.
        </div>
        }
       ...
       <div className="">         
         <div className="vendor-meta-item vendor-meta-item-bordered">
           <div
             ...
             className="rating-star gap-2 d-flex flex-row justify-content-center align-items-center">
             {SocialMedia != null
              ?
            <> 
            {SocialMedia.map((record, index) => (
               <>
             <a href={record.account_url}><img className="socail_icon_set" src={"https://callistoworld.io/lara/public/upload/"+record.account_profile_id.icon}/></a>
           ...
           <div style={{ float: "left" }} className="rating-count vendor-text">
             <a className='No_Review_Yet' href="#reviews"></a>
           </div>
     ...
     {BusinessListing.is_active == "active" &&
         <div class="alert alert-success" role="alert">
            Flat Discount : {BusinessListing.cashback}% on QR Code and Click to Pay Transaction.
        </div>
        }
    ...
    <div className="solution_cards_box">
      <div className="solution_card">
        ...
        <div className="solu_title text-center">
          <h3>Listing Balance</h3>
        </div>
        <div className="solu_description text-center">
          <p>
            {ListingWallet.main_wallet}
          </p>
          <button type="button" className="read_more_btn text-center">
            Read More
          </button>
        </div>
      </div>
  ...
  <div className="our_solution_category">
    <div className="solution_cards_box">
      <div className="solution_card">
        ...
        <div className="solu_title text-center">
          <h3>Cashback Duduction</h3>
        </div>
        <div className="solu_description text-center">
          <p>
          {ListingWallet.cashback_deduction}
          </p>
          <button type="button" className="read_more_btn text-center">
            View Transaction
          </button>
  ...
  <div className="our_solution_category">
    <div className="solution_cards_box">
      <div className="solution_card">
        ...
        <div className="solu_title text-center">
          <h3>Total Reconciliation</h3>
        </div>
        <div className="solu_description text-center">
          <p>
          {ListingWallet.reconciliation}
          </p>
          <button type="button" className="read_more_btn text-center">
            Read More
          </button>
  ...
  <div className="our_solution_category">
    <div className="solution_cards_box">
      <div className="solution_card">
        ...
        <div className="solu_title text-center">
          <h3>Total Profile Visits</h3>
        </div>
        <div className="solu_description text-center">
          <p>
            {BusinessListing.visit_count}
          </p>
          <button type="button" className="read_more_btn text-center">
            Read More
          </button>
   ...
   <div className="row">
     <div className="col-xl-12 col-lg-8 col-md-7 col-sm-12 col-12">
       {/*vendor-details */}
       <div className="">
         <div className="card ">
        ...
        <div className="sidebar-venue">
          <div className="card">
            ...
            <div className="card-body">
              ...
              <div className="qr_seta mr-5" id="qrCode1" style={{background:"white"}}>
      <QRCodeCanvas
      includeMargin={true}
      id="qrCode"
      bgColor={"#ffff00"}
