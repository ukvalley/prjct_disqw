...
const Edit_Social = () => {
    ...
    useEffect(() => {
      ...
      async function fetch_data_id(){
        ...
        axios.get("https://callistoworld.io/lara/public/api/SocialMediaById/"+id)
        .then(res => {
      
               
           console.log(res.data);
           setaccount_profile(res.data.SocialMedia.account_profile);
           setaccount_url(res.data.SocialMedia.account_url);
           setis_active(res.data.SocialMedia.is_active)
