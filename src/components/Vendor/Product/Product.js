...
const Product = () => {
  ...
  const handleSubmit = (event) =>{
    ...
    if(name,description,price_unit,discount_percentage,listing_id,product_image)
      {         
        ProductRegistration(name,description,price_unit,discount_percentage,listing_id,product_image,image_1,image_2,image_3,image_4,image_5,category);
    } 
    else {
      Swal.fire({
   ...
   function calculate_Price(percentage)
   {
      let discounted_amt = price_unit - (price_unit * (percentage/100));

      setDiscountedPrice(discounted_amt);
   }
  ...
  const vid = localStorage.getItem('bid');
   ...
   async function ProductRegistration(name,description,price_unit,discount_percentage,listing_id,product_image,image_1,image_2,image_3,image_4,image_5,category){
    ...
    await axios.post("https://callistoworld.io/lara/public/api/ProductRegistration",
    f_data ,
 { headers: {
            ...
            <div className="row g-0">
              <div className="col-lg-12">
                ...
                <form onSubmit={handleSubmit} encType="multipart/form-data">
                  ...
                  <div className="col-md-6">
                      <div className="form-outline">
                      <span className="text-left">Store Discount (%)</span>
                        <input
                          type="text"
                        ...
                        <p>Discounted Price will Be {DiscountedPrice}</p>
