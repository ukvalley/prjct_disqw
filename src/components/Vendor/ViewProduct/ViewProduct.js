               ...
               <div className="container-fluid">
                <div className="section">
                   ...
                   <div className='card col-md-12 mt-5 pt-2 px-2 py-2'>
                                            ...
                                            <button className="btn btn-primary add_buttonl mt-2 text-white"> <AiOutlinePlus/> <Link to="/BusinessUser/Product"> Add New </Link></button>
                                                    ...
                                                    {Products.map((record, index) => (
                                                      <>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <Link to={"/BusinessUser/EditProducts/"+record.id} className="list_icon_table"><a><FaEdit/></a></Link>
                                                            </td>
