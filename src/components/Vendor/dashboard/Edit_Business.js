...
const Edit_Business = () => {
  ...
  const handleFileSelect_im3= (event) => {
   ...
   async function BusinessRegistration(name,description,email,mobile,category,country,state,city,pincode,address,google_map_latitude,
    ...
    await axios.post("https://callistoworld.io/lara/public/api/BusinessUpdate/"+id,
    f_data ,
 { headers: {
...
const view_data = async () => {
  await axios.get("https://callistoworld.io/lara/public/api/BusinessSingleAdmin/"+id)
  .then(res => { 
...
Edit_Business.propTypes = {};

Edit_Business.defaultProps = {};
