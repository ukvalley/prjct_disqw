...
const Addsocial = () => {
    ...
    useEffect(() => {
      ...
      const handleSubmit = (event) =>{
        ...
        if(account_profile,account_url,is_active)
        {         
       ...
       async function SocialRegistration(account_profile,account_url,is_active){
        ...
        f_data.append('listing_id', vid);
        
       
       
     
        await axios.post("https://callistoworld.io/lara/public/api/SocialMediaRegistration",
        f_data ,
     { headers: {
    ...
    return (
        ...
        <main>
            <div className="Addsocial dashboard">
