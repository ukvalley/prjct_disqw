...
const Dashboard = () => {
  ...
  async function fetch_data() {
   ...
   await axios.get(`https://callistoworld.io/lara/public/api/GetVendorDetails/`+vid)
      .then(res => {
                        ...
                        <div className="solution_cards_box">
                          <div className="solution_card">
                            ...
                            <div className="solu_description text-center">
                              <p>
                                {VendorData.VendorWallet.main_wallet}
                              </p>
                      ...
                      <div className="our_solution_category">
                        <div className="solution_cards_box">
                          <div className="solution_card">
                            ...
                            <div className="solu_description text-center">
                              <p>
                                {VendorData.VendorWallet.received}
                              </p>
                              <button type="button" className="read_more_btn text-center">
                                View Transaction
                              </button>
                      ...
                      <div className="our_solution_category">
                        <div className="solution_cards_box">
                          <div className="solution_card">
                            ...
                            <div className="solu_description text-center">
                              <p>
                              {VendorData.VendorWallet.cashback_deduction}
                              </p>
                              <button type="button" className="read_more_btn text-center">
                                View Transaction
                              </button>
                      ...
                      <div className="our_solution_category">
                        <div className="solution_cards_box">
                          <div className="solution_card">
                            ...
                            <div className="solu_description text-center">
                              <p>
                              {VendorData.VendorWallet.reconciliation}
                              </p>
                              <button type="button" className="read_more_btn text-center">
                                Read More
                              </button>
